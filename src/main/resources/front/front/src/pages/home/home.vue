...
<div class="news" :style='{"margin":"20px 0 0 0","borderColor":"#dbd9f4","borderRadius":"8px","background":"#fff","borderWidth":"2px 1px 1px 1px","width":"68%","borderStyle":"solid","height":"auto","order":"1"}'>
	...
	<div class="title" :style='{"margin":"0px auto","borderRadius":"0 0 30px 30px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20221105/bb1ea9437beb4e1da8fcd1583db2f111.png) no-repeat,radial-gradient(circle, rgba(219,217,244,1) 0%, rgba(181,177,240,1) 100%)","width":"260px","lineHeight":"42px","height":"42px"}'>
		<span :style='{"color":"#333","fontSize":"22px"}'>大厦公告</span>
	</div>
...
<div class="lists" :style='{"margin":"20px 0 0","borderColor":"#dbd9f4","borderRadius":"8px","flexWrap":"wrap","background":"#fff","borderWidth":"1px 1px 1px 2px","display":"flex","borderStyle":"solid","justifyContent":"space-between","order":"4"}'>
	...
	<div class="title" :style='{"margin":"auto 0","alignItems":"center","textAlign":"center","background":"url(http://codegen.caihongy.cn/20221105/8dd5408f3db747ada55008950b9a3902.png) no-repeat,radial-gradient(circle, rgba(219,217,244,1) 0%, rgba(181,177,240,1) 100%)","display":"flex","width":"42px","lineHeight":"1.1","height":"260px"}'>
	  <span :style='{"color":"#333","fontSize":"22px"}'>图书信息展示</span>
	</div>
	...
	<div class="list list1 index-pv1" :style='{"width":"calc(100% - 42px)","padding":"10px 10px 0 10px","borderRadius":"8px","background":"#fff","height":"auto"}'>
		<div :style='{"cursor":"pointer","padding":"0 0 8px 0","margin":"10px 1%","borderRadius":"8px","background":"rgba(242, 242, 242,.6)","display":"inline-block","width":"18%","position":"relative","height":"auto"}' v-for="(item,index) in tushuxinxiList" :key="index" @click="toDetail('tushuxinxiDetail', item)" class="list-item animation-box">
			<img :style='{"width":"100%","objectFit":"cover","borderRadius":"8px 8px 0 0","display":"block","height":"210px"}' v-if="item.tushufengmian.substr(0,4)=='http'" :src="item.tushufengmian.split(',')[0]" alt="" />
			<img :style='{"width":"100%","objectFit":"cover","borderRadius":"8px 8px 0 0","display":"block","height":"210px"}' v-else :src="baseUrl + (item.tushufengmian?item.tushufengmian.split(',')[0]:'')" alt="" />
			<div class="name line1" :style='{"padding":"0px","color":"#666","textAlign":"center","background":"#f8f8fc","lineHeight":"24px","fontSize":"14px","height":"24px"}'>{{item.tushumingcheng}}</div>
			<div class="name line1" :style='{"padding":"0px","color":"#666","textAlign":"center","background":"#f8f8fc","lineHeight":"24px","fontSize":"14px","height":"24px"}'>{{item.tushufenlei}}</div>
			<div class="name line1" :style='{"padding":"0px","color":"#666","textAlign":"center","background":"#f8f8fc","lineHeight":"24px","fontSize":"14px","height":"24px"}'>{{item.chubanshe}}</div>
			<div class="name line1" :style='{"padding":"0px","color":"#666","textAlign":"center","background":"#f8f8fc","lineHeight":"24px","fontSize":"14px","height":"24px"}'>{{item.tushuzuozhe}}</div>
		</div>
	</div>
	...
	<div @click="moreBtn('tushuxinxi')" :style='{"border":"0","cursor":"pointer","margin":"10px auto","borderRadius":"30%","textAlign":"center","background":"radial-gradient(circle, rgba(231,230,244,1) 0%, rgba(219,217,244,1) 100%),#dbd9f4","display":"block","width":"18%","lineHeight":"32px"}'>
		<span :style='{"color":"#666","fontSize":"14px"}'>查看更多</span>
		<i v-if="true" :style='{"color":"#666","fontSize":"14px"}' class="el-icon-d-arrow-right"></i>
	</div>
