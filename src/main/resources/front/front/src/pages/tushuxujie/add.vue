    ...
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="借阅编号" prop="jieyuebianhao">
            <el-input v-model="ruleForm.jieyuebianhao" 
                placeholder="借阅编号" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="续借时间" prop="xujieshijian" >
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="续借天数" prop="xujietianshu">
            <el-input v-model="ruleForm.xujietianshu" 
                placeholder="续借天数" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="续借事由" prop="xujieshiyou">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="续借事由"
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('tushuxujie/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('tushuxujie/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
