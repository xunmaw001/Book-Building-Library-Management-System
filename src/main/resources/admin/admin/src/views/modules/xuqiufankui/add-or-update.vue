	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="反馈类型" prop="fankuileixing">
					<el-select :disabled="ro.fankuileixing" v-model="ruleForm.fankuileixing" placeholder="请选择反馈类型" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="反馈类型" prop="fankuileixing">
					<el-input v-model="ruleForm.fankuileixing"
						placeholder="反馈类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="反馈标题" prop="fankuibiaoti">
					<el-input v-model="ruleForm.fankuibiaoti" placeholder="反馈标题" clearable  :readonly="ro.fankuibiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="反馈标题" prop="fankuibiaoti">
					<el-input v-model="ruleForm.fankuibiaoti" placeholder="反馈标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="反馈时间" prop="fankuishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.fankuishijian" label="反馈时间" prop="fankuishijian">
					<el-input v-model="ruleForm.fankuishijian" placeholder="反馈时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="评分" prop="pingfen">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="评分" prop="pingfen">
					<el-input v-model="ruleForm.pingfen"
						placeholder="评分" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="反馈内容" prop="fankuineirong">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.fankuineirong" label="反馈内容" prop="fankuineirong">
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.pingfenOptions = "5,4,3,2,1".split(',')
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xuqiufankui/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xuqiufankuiCrossAddOrUpdateFlag = false;
						 this.parent.search();
