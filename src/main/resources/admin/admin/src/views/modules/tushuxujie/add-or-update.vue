	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="借阅编号" prop="jieyuebianhao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="续借时间" prop="xujieshijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.xujieshijian" 
						type="date"
						:readonly="ro.xujieshijian"
						placeholder="续借时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.xujieshijian" label="续借时间" prop="xujieshijian">
					<el-input v-model="ruleForm.xujieshijian" placeholder="续借时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="续借天数" prop="xujietianshu">
					<el-input v-model="ruleForm.xujietianshu" placeholder="续借天数" clearable  :readonly="ro.xujietianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="续借天数" prop="xujietianshu">
					<el-input v-model="ruleForm.xujietianshu" placeholder="续借天数" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="续借事由" prop="xujieshiyou">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="续借事由"
					  v-model="ruleForm.xujieshiyou" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.xujieshiyou" label="续借事由" prop="xujieshiyou">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.xujieshiyou}}</span>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				xujietianshu: [
					{ required: true, message: '续借天数不能为空', trigger: 'blur' },
					{ validator: validateIntNumber, trigger: 'blur' },
				],
				xujieshiyou: [
				],
	...
	created() {
		this.ruleForm.xujieshijian = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xujieshijian'){
							this.ruleForm.xujieshijian = obj[o];
							this.ro.xujieshijian = true;
							continue;
						}
						if(o=='xujietianshu'){
							this.ruleForm.xujietianshu = obj[o];
							this.ro.xujietianshu = true;
							continue;
						}
						if(o=='xujieshiyou'){
							this.ruleForm.xujieshiyou = obj[o];
							this.ro.xujieshiyou = true;
							continue;
						}
						if(o=='crossuserid'){
