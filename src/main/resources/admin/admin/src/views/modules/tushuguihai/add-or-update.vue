	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="归还备注" prop="guihaibeizhu">
					<el-input v-model="ruleForm.guihaibeizhu" placeholder="归还备注" clearable  :readonly="ro.guihaibeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="归还备注" prop="guihaibeizhu">
